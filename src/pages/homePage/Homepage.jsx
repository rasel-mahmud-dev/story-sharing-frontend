                ...
                <div className="mt-8">
                    <div style={{maxWidth: "400px"}}>
                        ...
                        <h1 className="text-black dark:text-dark-0 text-base  mb-2 ">
                            ...
                            to write, read,
                            and connect</h1>
                        <p className="text-dark-400   dark:text-dark-10 text-base">It's easy and free to post your
                            thinking
                ...
                <div className="flex ">
                    ...
                    <div className="hidden md:block" style={{maxWidth: "40%"}}>
                        ...
                        <div className="dt mt-8 ml-5">
                            <h4 className="font-medium text-xs text-gray-600 dark:text-gray-200">DISCOVER MORE OF WHAT
                                MATTERS TO YOU</h4>
